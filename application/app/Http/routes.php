...
Route::group(array('before' => 'if_logged_in_must_be_subscribed'), function(){
	...
	*/
		...
		Route::get( 'irasai/kategorija/{category}', 'ThemePostController@category' );
		Route::get( 'straipsnis/{slug}', 'ThemePostController@index' );
	...
	*/
		...
		Route::get('puslapis/{slug}', 'ThemePageController@index');
	...
	*/
	...
	|--------------------------------------------------------------------------
	*/
		Route::get('grojarastis',  function () {include('./content/themes/default/grok.php');});
