...
jQuery('.modpiclink').on("click",function() {
...
jQuery('.newarticle').removeClass('newarticle');
		...
		if (screenwidth>720) {
			if (jQuery('.werbung').length<1) {jQuery('.article:nth(6)').after( '' +
				'<div class="article spacearticle" style="height:265px;padding: 5px;"><span class="werbung"></span></div>' ); console.log("kviečiama ads funkcija"); }
...
var filename="";
 ...
 // Gibt es einen aktuellen Plan oder muss der Defaultplan geladen werden
	filename="/programmplaner/"+getlocation().charAt(0).toUpperCase() + getlocation().toLowerCase().slice(1)+"_"+jQuery('#kw-year').text()+".csv";
	...
	filename="/programmplaner/"+getlocation().charAt(0).toUpperCase() + getlocation().toLowerCase().slice(1)+"_"+jQuery('#kw-year').text()+".csv";
	load_programm_file(filename);
	},
	error: function(){
	 filename="/programmplaner/"+getlocation().charAt(0).toUpperCase() + getlocation().toLowerCase().slice(1)+"_default.csv"; 
	 load_programm_file(filename);
...
jQuery.post( filename, function( data ) {
	...
	max_hour = "0"+max_hour;
	 ...
	 if (tbl[ch].split("|")[3].length>1) { 
	 	...
	 	jQuery('.modpicwrapper').css("background-image","url('/sites/default/files/National/Energy_Logo_Programm_3.jpg')").fadeIn();
	 }
...
if (jQuery('a:contains(".mp3")').length>0) {
		...
		jQuery('.layoutmanager a:contains(".mp3"):first').parent().before('<link href="/sites/all/themes/zen_energy/css/audioplayer.css" rel="stylesheet"><script src="/sites/all/libraries/audiojs/audiojs/audio.min.js"></script><script src="/sites/all/themes/zen_energy/js/audioplayer.js"></script>');
	}
...
if (jQuery('a:contains(".mp4")').length>0) {
		...
		jQuery('.layoutmanager a:contains(".mp4"):first').parent().before('<link href="/sites/all/themes/zen_energy/css/audioplayer.css" rel="stylesheet"><script src="/sites/all/themes/zen_energy/js/videoplayer.js"></script>');
	}
...
jQuery.smartbanner({
  ...
  author: "RADIO STOTIS EXTRA FM", // What the author of the app should be in the banner (defaults to <meta name="author"> or hostname)
  price: 'All The Best Hits !', // Price of the app
  ...
  icon: "http://extrafm.eu/logo.png", // The URL of the icon (defaults to <meta name="apple-touch-icon">)
  iconGloss: null, // Force gloss effect for iOS even for precomposed
  url: null, // The URL for the button. Keep null if you want the button to link to the app store.
  button: 'Įdiegti', // Text for the install button
